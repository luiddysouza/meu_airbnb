...
import 'package:meu_airbnb/features/hospedagens/data/modelos/hospedagem_modelo.dart';
import 'package:meu_airbnb/features/hospedagens/data/modelos/imovel_modelo.dart';
...
HospedagemEntidade _entidadeFixture() => HospedagemEntidade(
  id: 'id-1',
  nomeHospede: 'João Silva',
  telefone: '+55 11 99999-0000',
  checkIn: _checkIn,
...
void main() {
  group('HospedagemModelo', () {
    group('fromJson', () {
      test('converte todos os campos corretamente', () {
        ...
        // Act
        final modelo = HospedagemModelo.fromJson(json);
    ...
    group('toJson', () {
      test('serializa todos os campos corretamente', () {
        // Arrange
        final modelo = HospedagemModelo.fromJson(_hospedagemJson());
      ...
      test('toJson → fromJson preserva os dados (round-trip)', () {
        // Arrange
        final original = HospedagemModelo.fromJson(_hospedagemJson());

        // Act
        final json = original.toJson();
        final restaurado = HospedagemModelo.fromJson(json);
    ...
    group('fromEntity / toEntity', () {
      test('fromEntity converte entidade para modelo corretamente', () {
        ...
        // Act
        final modelo = HospedagemModelo.fromEntity(entidade);
      ...
      test('fromEntity → toEntity preserva todos os campos', () {
        ...
        // Act
        final modelo = HospedagemModelo.fromEntity(original);
  ...
  group('ImovelModelo', () {
    ...
    test('fromJson converte corretamente', () {
      // Act
      final modelo = ImovelModelo.fromJson(imovelJson);
    ...
    test('fromJson com endereço null', () {
      ...
      // Act
      final modelo = ImovelModelo.fromJson(json);
    ...
    test('fromEntity → toEntity preserva todos os campos', () {
      ...
      // Act
      final modelo = ImovelModelo.fromEntity(entidade);
      final restaurada = modelo.toEntity();
