...
part of 'hospedagem_modelo.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

HospedagemModelo _$HospedagemModeloFromJson(Map<String, dynamic> json) =>
    HospedagemModelo(
...
Map<String, dynamic> _$HospedagemModeloToJson(HospedagemModelo instance) =>
    <String, dynamic>{
      'id': instance.id,
